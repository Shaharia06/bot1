# যদি telegram module না থাকে তাহলে অটো pip install করবে
import subprocess
import sys
...
ADMIN_ID = 6919881622  # শুধু এই আইডির ইউজার /info ব্যবহার করতে পারবে, /report পাবলিক
...
# ⚠️ main ফাংশন ঠিকভাবে চেক করতে হবে
